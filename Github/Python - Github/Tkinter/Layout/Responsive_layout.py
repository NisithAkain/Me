...
class App(tk.Tk):
    ...
    def create_medium_layout(self):
        ...
        ttk.Label(master=self.frame, text = "label 1 ", background='red'). grid(column=0, row=0, sticky='nsew', padx = 10, pady=10)
        ttk.Label(master=self.frame, text = "label 2 ", background='green'). grid(column=1, row=0, sticky='nsew',padx = 10, pady=10)
        ttk.Label(master=self.frame, text = "label 3 ", background='blue'). grid(column=0, row=1, sticky='nsew',padx = 10, pady=10)
        ttk.Label(master=self.frame, text = "label 4 ", background='yellow'). grid(column=1, row=1, sticky='nsew',padx = 10, pady=10)
